package br.com.devcoelho.bankapi.controller;

import br.com.devcoelho.bankapi.controller.dto.UserDto;
...
public record UserController(UserService userService) {
  ...
  @Operation(
      ...
      description = "Create a new user and return the created user's data")
  @ApiResponses(
      value = {
